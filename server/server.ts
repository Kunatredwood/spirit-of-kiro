...
import { WebSocketMessage, SignupMessage, SigninMessage, PullItemMessage, ListInventoryMessage, DiscardItemMessage, MoveItemMessage, UseSkillMessage, SellItemMessage, FetchPersonaMessage, PeekDiscardedMessage, BuyDiscardedMessage, VerifyEmailMessage, ResendVerificationMessage, ForgotPasswordMessage, ResetPasswordMessage, ConnectionState } from './types';
    ...
    async message(ws: ServerWebSocket<WebSocketData>, message: string | Buffer) {
      ...
      switch (data.type) {
        ...
        case 'forgot_password':
          ...
          break;
        case 'reset_password':
          result = await handleResetPassword(ws.data.state, data as ResetPasswordMessage);
          ws.send(formatMessage(result.type, result.body));
          break;
        default:
